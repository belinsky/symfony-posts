...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/belinsky/projects/test_sy/log/custom_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/belinsky/projects/test_sy/cache/custom/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/belinsky/projects/test_sy/apps/custom/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/belinsky/projects/test_sy/cache/custom/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/belinsky/projects/test_sy/apps/custom/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 465,
      'encryption' => 'ssl',
      'username' => 'belinsky.mis@gmail.com',
      'password' => '270690lena',
    ),
  ),
))));
